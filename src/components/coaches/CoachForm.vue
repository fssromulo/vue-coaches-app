<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{ invalid: !areas.isValid }">
            ...
            <p v-if="!areas.isValid && !formIsValid">First Name must have a valid value!</p>
        </div>
        <p class="invalid" v-if="!formIsValid">Please fix the above error and submit again.</p>
